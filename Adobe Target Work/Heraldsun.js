<style>
    ...
    .step-name.blue {
        color: #19ACF0 !important;
        background-color: transparent !important;
    }
    .blue {
        background-color: #19ACF0 !important;
    }
    ...
    (function() {
        ...
        var newV21 = function() {
          ...
          if (!searchParams.get('v21suffix')) {
                searchParams.set('v21suffix', '19-b');
        ...
        function verifyMobile() {
            ...
            if (document.querySelector('.offer-highlight').textContent.includes('12')) {
